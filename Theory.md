...
> <span style="background-color:red; color:black">АЛАРМ!</span> Некоторые компиляторы (GCC, Clang) предоставляют флаг <span style="color:orange">_-Wparentheses_</span>, который предупреждает о подозрительной расстановке скобок. Рекомендуется всегда включать этот флаг и явно расставлять скобки, чтобы избежать неоднозначностей.
