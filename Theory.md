...
> При помощи модификатора <span style="color:orange">_static_</span> можно задать статический срок хранения даже переменным с <span style="color:orange">_блочной видимостью_</span>.
```c
